...
const OTHER_AVATAR      = '<?php echo e(addslashes($otherUser->avatar_url ?? "")); ?>';
const MY_INITIAL        = '<?php echo e(addslashes(strtoupper(substr($authUser->getName(), 0, 1)))); ?>';
const OTHER_INITIAL     = '<?php echo e(addslashes(strtoupper(substr($nickname ?: $otherUser->getName(), 0, 1)))); ?>';
const MORE_URL          = '<?php echo e(route("chat.dm.more", $otherUser->user_id, false)); ?>';
