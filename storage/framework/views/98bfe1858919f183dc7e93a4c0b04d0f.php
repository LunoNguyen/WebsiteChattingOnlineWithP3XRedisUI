...
<div class="flex h-full flex-col">
  ...
  <div class="bg-white border-b border-gray-200 px-4 py-3 flex items-center gap-3 flex-shrink-0">
    ...
    <div class="flex-1">
      <h3 class="font-semibold text-gray-900 text-sm">
        ...
        <?php if($nickname): ?><span class="text-gray-400 font-normal text-xs ml-1">(<?php echo e($otherUser->username); ?>)</span><?php endif; ?>
      </h3>
      <p class="text-xs <?php echo e($otherUser->is_online ? 'text-green-500' : 'text-gray-400'); ?>">
    ...
    <div class="flex items-center gap-2">
      ...
      <form method="POST" action="<?php echo e($isBlocked ? route('friends.unblock') : route('friends.block')); ?>">
        ...
        <button type="submit" class="p-2 text-gray-400 hover:text-red-500 hover:bg-gray-100 rounded-lg transition"
          title="<?php echo e($isBlocked ? 'Bỏ chặn' : 'Chặn người dùng'); ?>">
  ...
  <div id="nickname-modal" class="hidden fixed inset-0 bg-black/50 flex items-center justify-center z-50">
    <div class="bg-white rounded-xl p-5 w-80 shadow-xl">
      <h4 class="font-semibold text-gray-900 mb-3">Đặt nickname cho <?php echo e($otherUser->getName()); ?></h4>
  ...
  <div id="messages-container" class="flex-1 overflow-y-auto px-4 py-4 space-y-3 bg-gray-50">
    ...
    <?php else: ?>
      <?php $__empty_1 = true; $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <?php $isMine = $msg->sender_id === $authUser->user_id; ?>
...
const SEND_URL  = '<?php echo e(route("chat.dm.send", $otherUser->user_id)); ?>';
